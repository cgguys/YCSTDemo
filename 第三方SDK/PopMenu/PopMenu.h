...
typedef NS_ENUM(NSInteger, PopMenuLayoutStyle) {
    PopMenuLayoutStyleGrid = 0,
    /** 从右侧入 左侧出*/
    PopMenuLayoutStyleArc = 1,
};
...
@property (nonatomic, assign) PopMenuLayoutStyle menuLayoutStyle;
...
@property (nonatomic ,copy) void(^willCancelBlock)();
